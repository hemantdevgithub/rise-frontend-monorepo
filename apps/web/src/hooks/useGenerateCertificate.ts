...
import { OneCertificate } from "@/types";
...
export function useGenerateCertificate({
  ...
  const generateCertificateImage = async (): Promise<void> => {
    try {
      ...
      const certificatDescriptionText = `has successfully completed ${certificateDetails.course} Full Stack Web Development Course`;
