...
const filtersSlice = createSlice({
  ...
  reducers: {
    ...
    selectCategory: (
      ...
      } else if (action.payload.name === "research-and-developments") {
        state.researchAndDevelopments.category = action.payload.category;
      } else if (action.payload.name === "quizzes") {
        state.quizzes.category = action.payload.category;
      }
    },
  },
});
...
export const selectQuizzesFilters = (state: RootState) => state.filters.quizzes;
